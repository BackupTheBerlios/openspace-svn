...
/////////////////////////////////////////////////////////////////////////////
//
// C++ Implementation: OSFileListItem
//
...
FXIMPLEMENT( OSFileListItem, FXIconItem, NULL, 0 )

OSFileListItem::OSFileListItem( void )
{
    // construction
}
        
OSFileListItem::OSFileListItem( FXIconList* list, OSFile osf, FXColor col, FXColor backcol, FXIcon* ic1, FXIcon* ic2 ) : FXIconItem( osf.name.c_str(), ic1, ic2, NULL ), osf( osf )
{
    this->list = list;
    color = col;
    backcolor = backcol;
...
// Draw detail
void OSFileListItem::drawDetails( const FXIconList* list, FXDC& dc, FXint x, FXint y, FXint, FXint h ) const
{
...
void OSFileListItem::drawBigIcon( const FXIconList* list, FXDC& dc, FXint x, FXint y, FXint w, FXint h ) const
{
